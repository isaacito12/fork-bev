...
plugin = matlab.unittest.plugins.CodeCoveragePlugin.forFile( ...
  ...
  ...
  fullfile(TopFolder, "SimulationCases", "MotorDriveUnit_Case_Constant.mlx")
  fullfile(TopFolder, "SimulationCases", "MotorDriveUnit_Case_Drive.mlx")
  fullfile(TopFolder, "SimulationCases", "MotorDriveUnit_Case_Random.mlx")
  fullfile(TopFolder, "SimulationCases", "MotorDriveUnit_Case_RegenBrake.mlx")
  ...
  fullfile(TopFolder, "Utility", "Configuration", "MotorDriveUnit_loadCase.m")
  fullfile(TopFolder, "Utility", "Configuration", "MotorDriveUnit_loadCase_Constant.m")
  fullfile(TopFolder, "Utility", "Configuration", "MotorDriveUnit_loadCase_Drive.m")
  fullfile(TopFolder, "Utility", "Configuration", "MotorDriveUnit_loadCase_Random.m")
  fullfile(TopFolder, "Utility", "Configuration", "MotorDriveUnit_loadCase_RegenBrake.m")
